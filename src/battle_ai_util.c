...
struct SimulatedDamage AI_CalcDamageSaveBattlers(u32 move, u32 battlerAtk, u32 battlerDef, u8 *typeEffectiveness, enum DamageRollType rollType)
{
    ...
    dmg = AI_CalcDamage(move, battlerAtk, battlerDef,  typeEffectiveness, AI_GetWeather(AI_DATA), rollType);
